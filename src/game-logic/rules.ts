...
export const STANDARD_SCORING_RULE_DEFINITIONS: RuleDefinition[] = [
  ...
  { detector: "wind-or-dragon", name: "Honor Set", description: "Each Pong or Gong made from matching Wind or Dragon tiles", points: 1, category: everyday },
  { detector: "no-wind-or-dragon", name: "No Honor Tiles", description: "The winning hand contains no honor tiles (Winds or Dragons) in any set or pair", points: 1, category: everyday },
  ...
  { detector: "missing-two-suits", name: "Missing Two Suits", description: "Only one numbered suit is used; honor tiles are allowed", points: 2, category: patterns },
  { detector: "all-simple", name: "All Simple", description: "Only numbered tiles 2 through 8; no honor tiles", points: 2, category: patterns },
  { detector: "small-chi", name: "Xiao Ping Hu (Small Chi)", description: "Five Chi; honor tiles are allowed only as the pair", points: 3, category: patterns },
  ...
  { detector: "five-families", name: "Five Families", description: "Uses all five tile families: Characters, Bamboo, Dots, Winds, and Dragons", points: 5, category: patterns },
  ...
  { detector: "mixed-terminals-honors", name: "Mixed Terminals and Honors", description: "Only terminal tiles (1 and 9) and honor tiles (Winds and Dragons)", points: 8, category: patterns },
  ...
  { detector: "big-chi", name: "Da Ping Hu (Big Chi)", description: "Five Chi with a numbered pair and no honor tiles", points: 10, category: patterns },
  ...
  { detector: "one-mixed-suit", name: "One Mixed Suit", description: "One numbered suit together with honor tiles", points: 15, category: patterns },
  { detector: "pure-terminals", name: "Pure Terminals", description: "Only numbered 1 and 9 tiles; no honor tiles", points: 15, category: patterns },
  ...
  { detector: "terminals-or-honors-every-set", name: "Terminal or Honor in Every Set", description: "Every set and the pair contains a terminal tile (1 or 9) or an honor tile (Wind or Dragon)", points: 30, category: limits },
  ...
  { detector: "pure-one-suit", name: "Pure One Suit", description: "Only one numbered suit; no honor tiles", points: 40, category: limits },
  ...
  { detector: "all-winds-dragons", name: "All Honors", description: "The hand contains only honor tiles: Winds and Dragons", points: 50, category: limits },
